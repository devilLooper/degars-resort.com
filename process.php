...
try {
    ...
    $response = $client->request('POST', 'https://api.paymongo.com/v1/sources', [
        'body' => '{"data":{"attributes":{"amount":'.$amount.',"redirect":{"success":"https://degarsmanor.000webhostapp.com/degarsmanor/success.php?pcus_id='.$pcus_id.'&pid='.$pid.'","failed":"https://degarsmanor.000webhostapp.com/degarsmanor/failed.php?pcus_id='.$pcus_id.'&pid='.$pid.'"},"type":"gcash","currency":"PHP"}}}',
        'headers' => [
