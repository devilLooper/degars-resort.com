...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO `e_transaction` (`transac_ref`, `eid`, `cust_ID`, `payment_method`, `mode_of_payment`, `totalrate`, `added_charge`, `add_ons`,`amountReceived`,`currentBalance`) VALUES ('$transac_ref', '$eid ', '$cust_ID', '$payment_method', '$mode_of_payment', '$totalrate', '$added_charge','$add_ons', '$amountRecieved','$currentBalance')";
  ...
  curl_setopt_array($curl, array(
    ...
    'redirectsuccessurl' => 'http://localhost/degars/suc.php?eid='.$eid.'&transac_ref='.$transac_ref.'',
    'redirectfailurl' => 'http://localhost/degars/suc.php',  
    'description' => 'Degars Resort Payment- Transaction Ref. '.$transac_ref.''
    ),
  ));
