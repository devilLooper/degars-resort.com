        ...
        <div class="col-md-6">
            <div class="card px-5 py-5">
                <div class="position-relative m-2">
                    ...
                    <hr>
                    <form action='portalquery/insertCustomer.php' method="POST">
                        <!-- 2 column grid layout with text inputs for the first and last names -->
                        <div class="row mb-2">
                            <div class="col-sm">
                                <div class="form-outline">
                                    <?php 
                                    $sql = "SELECT eid FROM e_reservation ORDER BY resCreated DESC LIMIT 1";
                                    $result = $db -> query($sql);
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            <a class="btn btn-secondary me-md-2" name="onbackdelete" href="portalquery/onback_delete_reservation.php?eid=<?php echo $_SESSION['eid'];?>">Back</a>
