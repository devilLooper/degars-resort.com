        ...
        <div class="modal-content">
                ...
                <table class="table table-responsive-lg" id="example" class="display nowrap" style="width:100%">
                    ...
                    <tbody>
                        <tr>
                            ...
                            WHERE cust_ID = '$cust_ID' AND eid = '$eid'";
                            ...
                            if (isset($_GET['cust_ID']) && isset($_GET['eid'])) {
                            $cust_ID = $_GET['cust_ID'];
                            $eid = $_GET['eid'];
                            ...
                            <td>
                                <a style="border: 0" class="btn btn-outline-danger" ;
                                    href="delete.php?purchased_id=<?php echo $row['purchased_id'];?>&cust_ID=<?php echo $row['cust_ID'];?>&eid=<?php echo $row['eid'];?>"
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-outline-success float-lg-end"
                    href="../exclusive/proceed_to_payment.php?eid=<?php echo $eid;?>&cust_ID=<?php echo $cust_ID;?>">Proceed
                    to Payment</a>
            </div>
        </div>
    </div>
    ...
    <div class="row g-2">
        <form action="" method="POST">
            <div class="input-group mb-3">
                ...
                <button type="button" class="btn btn-warning position-relative mx-2 btn-sm" data-bs-toggle="modal"
                    ...
                    <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger">
                        <?php 
                        $count_product = mysqli_query($db, "SELECT * FROM mypurchased WHERE cust_ID = $cust_ID");
...
<div class="container-sm my-5">
    <div class="row">
        <div class="col-lg-12">
            <form action="addItem.php?cust_ID = <?php echo $cust_ID; ?>&<?php echo $eid; ?>" method="post">
