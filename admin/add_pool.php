        ...
        <nav id="sidebar" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
            ...
            <div class="position-sticky pt-md-5">
                <ul class="nav flex-column">
                    ...
                    <li>
                        <a class="nav-link active" href="add_pool.php">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
...
<main class="col-md-9 ml-sm-auto col-lg-10 px-md-4 py-4">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">Add Pool</h5>
                ...
                <div class="modal-body">
                    <form action="" method="post">
                        ...
                        <div class="form-outline mb-4">
                            <label class="form-label" for="form7Example1">Pool Name</label>
                            <input type="text" id="form7Example1" class="form-control" name="poolName" />
                        </div>
                        <!-- Description -->
                        <div class="form-outline mb-4">
                        ...
                        <!--Cottage Name input -->
                        <div class="form-outline mb-4">
                            <label class="form-label" for="form7Example1">Pool Rates</label>
                            <input type="text" id="form7Example1" class="form-control" name="poolRates" />
                        </div>
                </div>
    ...
    <table id="example" class="display nowrap" style="width:100%">
        ...
        <tbody>
            <?php $results = mysqli_query($db, "SELECT * FROM pools"); ?>
            <?php while ($row = $results->fetch_assoc()) { ?>
            <tr>
                <td><?php echo $row['pool_ID']; ?></td>
                <td><?php echo $row['poolName']; ?></td>
                <td><?php echo $row['description']; ?></td>
                <td><?php echo $row['poolRates']; ?></td>
                <td>
                    <a class="btn btn-primary" href="edit_pool.php?pool_ID=<?php echo $row['pool_ID']; ?>"
                        name="update"><i class="fa-solid fa-pen-to-square"></i> Update</a>
                    <a class="btn btn-danger" href="delete/delpool.php?pool_ID=<?php echo $row['pool_ID']; ?>"
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "INSERT INTO `pools`(`poolName`, `description`, `poolRates`) VALUES ('$poolName','$description','$poolRates')";
        $result = $db->query($sql);
