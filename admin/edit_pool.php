...
<main class="col-md-9 ml-sm-auto col-lg-10 px-md-4 py-4">
    ...
    <form action="" method="post">
        ...
        <div class="form-outline mb-4">
            <label class="form-label" for="form4Example1">Pool Name</label>
            <input type="text" id="form4Example1" class="form-control" name="poolName"
                value="<?php echo $poolName; ?>" />
        </div>
        <!-- Message input -->
        <div class="form-outline mb-4">
        ...
        <div class="form-outline mb-4">
            <label class="form-label" for="form4Example1">Pool Rates</label>
            <input type="text" id="form4Example1" class="form-control" name="poolRates" value="<?php echo $poolRates; ?>" />
        </div>
        <!-- Submit button -->
        <button type="button" class="btn btn-secondary mb-4"><a style="text-decoration: none; color: #fff;"
                href="add_pool.php">Back</a></button>
