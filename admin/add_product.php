...
<?php 
    if (isset($_POST['submit'])) {
        ...
        $sql = "INSERT INTO `product`(`productName`, `productCategory`, `stockQty`, `buy_price`, `sale_price`)
        VALUES ('$productName','$categoryName','$stockQty','$buy_price','$sale_price')";
        $result = $db->query($sql);
        if ($result == TRUE) {
...
<!-- Sections -->
<!-- endofsidebar -->
<div class="d-grid gap-2 d-sm-flex justify-content-md-end p-2">
</div>
<!-- Add cottages -->
<!-- Modal -->
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="staticBackdropLabel">Add Cottages</h5>
            ...
            <div class="modal-body">
                <form action="" method="post">
                    ...
                    <div class="form-outline mb-4">
                        ...
                        <input type="text" id="form7Example1" class="form-control" name="productName" />
                    </div>
                    <label class="form-label" for="">Product Name</label>
                    <select class="form-select" aria-label="Default select example" name="categoryName">
                        <option selected>Select Category</option>
                        <option>Makahubog</option>
                        <option>Makaluya</option>
                    </select>
                    <!-- Description -->
                    <div class="form-outline mb-4">
                        <label class="form-label" for="form7Example1">Stocks</label>
                        <input type="text" id="form7Example1" class="form-control" name="stockQty" />
                    </div>
                    <!--Cottage Name input -->
                    <div class="form-outline mb-4">
                        <label class="form-label" for="form7Example1">Buy Price</label>
                        <input type="text" id="form7Example1" class="form-control" name="buy_price" />
                    </div>
                    <!--Cottage Name input -->
                    <div class="form-outline mb-4">
                        <label class="form-label" for="form7Example1">Sale Price</label>
                        <input type="text" id="form7Example1" class="form-control" name="sale_price" />
                    </div>
            </div>
    ...
    <table id="example" class="display nowrap" style="width:100%">
        ...
        <tbody>
            <tr>
                ...
                <td>
                    <a class="btn btn-primary" href="edit_product.php?product_Id=<?php echo $row['product_Id']; ?>"
                        name="updateProduct"><i class="fa-solid fa-pen-to-square"></i> Update</a>
                    <a class="btn btn-danger" href="delete/delprod.php?product_Id=<?php echo $row['product_Id']; ?>"
