...
<main class="col-md-9 ml-sm-auto col-lg-10 px-md-4 py-4">
    <h1 class="pl-2">Edit Cottages</h1>
    <hr>
    <form action="" method="post">
        <!-- Hidden -->
        <input type="hidden" name="cottageType_ID" value="<?php echo $cottageType_ID; ?>">
        <!-- Name input -->
        <div class="form-outline mb-4">
            <label class="form-label" for="form4Example1">Cottage Name</label>
            <input type="text" id="form4Example1" class="form-control" name="cottageName"
                value="<?php echo $cottageName; ?>" />
        </div>
        <!-- Message input -->
        <div class="form-outline mb-4">
            <label class="form-label" for="form4Example1">Description</label>
            <input type="text" id="form4Example1" class="form-control" name="description" value="<?php echo $description; ?>" />
        </div>
        <div class="form-outline mb-4">
            <label class="form-label" for="form4Example1">Price</label>
            <input type="text" id="form4Example1" class="form-control" name="price" value="<?php echo $price; ?>" />
        </div>
        <!-- Submit button -->
        <button type="button" class="btn btn-secondary mb-4"><a style="text-decoration: none; color: #fff;"
                href="add_cottages.php">Back</a></button>
        <button type="submit" class="btn btn-primary mb-4" value="update" name="update">Update</button>
    </form>
</main>
<script>
