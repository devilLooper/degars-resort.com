...
<main class="col-md-9 ml-sm-auto col-lg-10 px-md-4 py-4">
    ...
    <hr>
    <form class="w-50" action="edit_product.php?product_Id=<?php echo $product_Id; ?>" method="POST">
        <!-- Hidden -->
        <input type="hidden" name="product_Id" value="<?php echo $product_Id; ?>">
        <!-- Name input -->
        <div class="form-outline mb-4">
            <label class="form-label" for="form4Example1">product Name</label>
            <input type="text" id="form4Example1" class="form-control" name="productName"
        ...
        <select class="form-select" aria-label="Default select example" name="productCategory">
            ...
            <option value="Makahubog">Makahubog</option>
            <option value="Makaluya">Makaluya</option>
        </select>
        <!-- Message input -->
        <div class="form-outline mb-4">
            <label class="form-label" for="form4Example1">Stocks</label>
            <input type="text" id="form4Example1" class="form-control" name="stockQty"
                value="<?php echo $stockQty; ?>" />
        </div>
        <div class="form-outline mb-4">
            <label class="form-label" for="form4Example1">Buy Price</label>
            <input type="text" id="form4Example1" class="form-control" name="buy_price"
                value="<?php echo $buy_price; ?>" />
        </div>
        <div class="form-outline mb-4">
            <label class="form-label" for="form4Example1">Sale Price</label>
            <input type="text" id="form4Example1" class="form-control" name="sale_price"
                value="<?php echo $sale_price; ?>" />
        </div>
        <!-- Submit button -->
        <button type="button" class="btn btn-secondary"><a style="text-decoration: none; color: #fff;"
                href="add_product.php">Back</a></button>
