...
<main class="col-md-9 ml-sm-auto col-lg-10 px-md-4 py-4">
    ...
    <form action="" method="post">
        ...
        <div class="form-outline mb-4">
            ...
            <input type="text" id="form4Example1" class="form-control" name="roomName"
        ...
        <div class="form-outline mb-4">
            <label class="form-label" for="form4Example1">Room Rates</label>
            <input type="text" id="form4Example1" class="form-control" name="roomRates" value="<?php echo $roomRates; ?>" />
        </div>
        <!-- Submit button -->
