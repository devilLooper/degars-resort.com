...
<main class="col-md-9 ml-sm-auto col-lg-10 px-md-4 py-4">
    <ul class="nav nav-tabs">
        <li class="nav-item">
            ...
            <a class="nav-link active" aria-current="page" href="#">Reservations
    ...
    <table id="responsiveTable" class="display nowrap" style="width:100%">
        ...
        <tbody>
            <tr>
                <?php 
                $results = mysqli_query($db,"SELECT tr.transac_ID,tr.transac_ref,tr.mode_of_payment,tr.totalrate,tr.added_charge,tr.add_ons,tr.amountReceived,tr.currentBalance,e.eid,e.resDate,e.status,e.checkouturl,c.cust_ID
                ...
                <td class="text-danger"><strong><?php echo $row['resDate']; ?></strong></td>
                ...
                <td>
                    <a id=""
                        href="upexstatus.php?transac_ID=<?php echo $row['transac_ID']; ?>&eid=<?php echo $row['eid'];?>"
                        onclick="return confirm('Are you sure you want to approved this reservation?');"><i
                            class="fa-solid fa-pen-to-square"></i></a>
                    <a id="" href="cancelexstatus.php?eid=<?php echo $row['eid'];?>"
                        onclick="return confirm('Are you sure you want to cancel this reservation?');"><i
                            class="fa-sharp fa-solid fa-ban text-warning"></i></a>
                    <a id=""
                        href="viewpurchased.php?eid=<?php echo $row['eid'];?>&cust_ID=<?php echo $row['cust_ID'];?>"
                        onclick="return confirm('Proceed to view purchased products?');"><i
                            class="fa-solid fa-cart-shopping text-dark"></i></i></a>
                    <a onclick="return confirm('Are you sure you want to delete this reservation?');"
                        class="text-danger" id=""
                        href="deleteres.php?transac_ID=<?php echo $row['transac_ID'];?>&eid=<?php echo $row['eid']; ?>&cust_ID=<?php echo $row['cust_ID']; ?>"><i
