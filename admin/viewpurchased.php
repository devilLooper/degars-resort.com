...
<main class="col-md-9 ml-sm-auto col-lg-10 px-md-4 py-4">
    <h1 class="pl-2">Reservations | Purchased Product</h1>
    <div class="d-grid gap-2 d-sm-flex justify-content-md-end p-2">
    <a href="viewqrtransac.php"> View QR transaction <i class="fa-solid fa-angles-right"></i></a>
    <a class="text-danger" href="viewpackageres.php"> View Package Reservation <i class="fa-solid fa-angles-right"></i></a>
    </div>
    <hr>
