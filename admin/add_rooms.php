        ...
        <nav id="sidebar" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
            ...
            <div class="position-sticky pt-md-5">
                <ul class="nav flex-column">
                    ...
                    <a class="nav-link active" href="add_rooms.php">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
...
<main class="col-md-9 ml-sm-auto col-lg-10 px-md-4 py-4">
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "INSERT INTO `rooms`(`roomName`, `description`, `roomRates`) VALUES ('$roomName','$description','$roomRates')";
        $result = $db->query($sql);
        if ($result == TRUE) {
                ...
                <div class="modal-body">
                    <form action="" method="post">
                        ...
                        <div class="form-outline mb-4">
                            <label class="form-label" for="form7Example1">Room Name</label>
                            <input type="text" id="form7Example1" class="form-control" name="roomName" />
                        </div>
                        <!-- Description -->
                        <div class="form-outline mb-4">
                        ...
                        <!--Cottage Name input -->
                        <div class="form-outline mb-4">
                            <label class="form-label" for="form7Example1">roomRates</label>
                            <input type="text" id="form7Example1" class="form-control" name="roomRates" />
                        </div>
                </div>
    ...
    <table id="example" class="display nowrap" style="width:100%">
        ...
        <tbody>
            ...
            ?>
                ...
                <td>
                    <a class="btn btn-primary" href="edit_room.php?room_ID=<?php echo $row['room_ID']; ?>"
                        name="update"><i class="fa-solid fa-pen-to-square"></i>Update</a>
                    <a class="btn btn-danger" href="delete/delroom.php?room_ID=<?php echo $row['room_ID']; ?>"
