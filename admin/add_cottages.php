        ...
        <nav id="sidebar" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
            ...
            <div class="position-sticky pt-md-5">
                <ul class="nav flex-column">
                    ...
                    <a class="nav-link active" href="add_cottages.php">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
...
<main class="col-md-9 ml-sm-auto col-lg-10 px-md-4 py-4">
    ...
    if (isset($_POST['submit'])) {
        ...
        $price = $_POST['price'];
        $sql = "INSERT INTO `cottageType`(`cottageName`, `description`, `price`) VALUES ('$cottageName','$description','$price')";
        $result = $db->query($sql);
        if ($result == TRUE) {
...
?>
                ...
                <div class="modal-body">
                    <form action="" method="post">
                        ...
                        <div class="form-outline mb-4">
                            <label class="form-label" for="form7Example1">Cottage Name</label>
                            <input type="text" id="form7Example1" class="form-control" name="cottageName" />
                        </div>
                        <!-- Description -->
                        <div class="form-outline mb-4">
                            <label class="form-label" for="form7Example1">Description</label>
                            <input type="text" id="form7Example1" class="form-control" name="description" />
                        </div>
                        <!--Cottage Name input -->
                        <div class="form-outline mb-4">
                            <label class="form-label" for="form7Example1">Price</label>
                            <input type="text" id="form7Example1" class="form-control" name="price" />
                        </div>
                </div>
    ...
    <table id="example" class="display nowrap" style="width:100%;">
        ...
        <tbody>
            ...
            "SELECT * FROM cottagetype"); 
            ?>
            <?php while ($row = $results->fetch_assoc()) { ?>
            <tr>
                <td><?php echo $row['cottageType_ID']; ?></td>
                <td><?php echo $row['cottageName']; ?></td>
                <td><?php echo $row['description']; ?></td>
                <td><?php echo $row['price']; ?></td>
                <td>
                    <a class="btn btn-primary"
                        href="edit_cottages.php?cottageType_ID=<?php echo $row['cottageType_ID']; ?>" name="update"><i
                            class="fa-solid fa-pen-to-square"></i> Update</a>
                    <a class="btn btn-danger"
                        href="delete/delcott.php?cottageType_ID=<?php echo $row['cottageType_ID']; ?>" name="delete"
                        onclick="return confirm('Are you sure you want to delete?');"><i class="fa-solid fa-trash"></i>
                        Delete</a>
                </td>
            </tr>
            <?php } ?>
